...
// @Slf4j
// @Service
// public class SearchRewriteServiceImpl implements SearchRewriteService {
//
...
//                + "- 生成搜索查询时，请使用如下格式回答：{ \"query\": \"query_key_word1,query_key_word2\",
// \"time\":"
...
//
//    public SearchRewriteServiceImpl(
...
//            log.error("rewrite final fail, error message: {}",
// Throwables.getStackTraceAsString(e));
...
//
//        InvokeModelParam invokeModelParamLegacy = buildInvokeModelParam(messages, param);
//
