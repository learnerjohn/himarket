#!/usr/bin/env bash
# Portal 开发者账号注册与订阅初始化钩子
# 由 deploy.sh 在部署就绪后自动调用
# 继承环境变量: NS, FRONT_USERNAME, FRONT_PASSWORD, ADMIN_USERNAME, ADMIN_PASSWORD
